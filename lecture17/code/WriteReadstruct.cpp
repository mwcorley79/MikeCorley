//example: serialize and deseralize user defined types and persist to files  
...
//pass b by reference: changes to b are visiable in the caller scope: (struct Book& b)
void printBytes(struct Book& b)
{
   ...
   std::cout << *(((char*) &b) + sizeof(int)) << std::endl;
