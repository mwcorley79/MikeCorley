/* This demo: exec_example.c - demonstrates the exec system call
  "exec" is a process loader, and used to load a different process image, into context of an existing process.  
   This example loads the /bin/ls process image into the existing "exec_example" process 
