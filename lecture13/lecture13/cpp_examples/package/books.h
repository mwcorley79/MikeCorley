...
class BookCollection
{
   public:
     ...
     // HW # 5: excercise: write a member function to Find a book in the collection based on its Id
     // the function definition should be placed in books.cpp
     Book FindBook(int id); 

     // HW # 5: exercise: write a memmber function to Delete a book based on its Id, 
     // the function definition should be placed in books.cpp
